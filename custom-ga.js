    ...
    */
        ...
        o.swapChildren = function(child1, child2) {
            ...
            if (index1 !== -1 && index2 !== -1) {
                ...
                throw new Error(child1 + " " + child2 + " Both objects must be a child of the caller " + o);
            }
        };
...
GA.plugins = function(ga) {
  ...
  */
    ...
    ga.scaleToWindow = function(backgroundColor) {
        ...
        ga.canvas.style.transformOrigin = "50% 50%"; //TODO: was originall 0 0 - this a problem?
        ...
        //TODO: replace all of this with a single CSS line?
  ...
  */
    ga.scaleToFit = function(dimension, color) {
        ...
        var canvasRatio = ga.canvas.height;
        ...
        tiledMap.layers.forEach(function(tiledLayer){
            ...
            if (tiledLayer.type === "tilelayer") {
                ...
                + (spacing * Math.floor((gid - 1) / numberOfTilesetColumns));
                        ...
                        var tilesArray = tiledMap.tilesets[0].tiles;
                        var tileproperties = {};

                        // CD - Hack to make the code work with Tiled 1.4 JSON export
                        Object.entries(tilesArray).forEach(function([key, value]) {
                            var listOfTileIdFollowedByProperties = [];
                            Object.entries(value).forEach(function([key, value]) {
                                //tileproperties["" + id] = {}
                                //console.log(tileproperties["" + tileElement.id]);
                                listOfTileIdFollowedByProperties.push(value);
                            });
                            var newDict = {};
                            listOfTileIdFollowedByProperties[1].forEach(item => {
                                newDict[item["name"]] = item["value"];
                            });
                            tileproperties["" + listOfTileIdFollowedByProperties[0]] = newDict;
                        });
